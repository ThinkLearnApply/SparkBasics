...
def main(args:Array[String]):Unit={
		...
		val data = sc.textFile("file:///D:/data/datatxns",1)  // change according to your path
		...
		df.write.parquet("file:///D:/data/parquet")
		println
		println("===Parquet generated using dataframe df.write.parquet ===")
		println
}
